...
[**Windows 安装程序（.exe）**](https://github.com/freedomxia/naigrey-pet/releases/download/windows-v0.2.4/naigrey-windows-0.2.4-x64-setup.exe) · [**macOS 下载（.zip）**](https://github.com/freedomxia/naigrey-pet/releases/download/v3.4.0/naigrey-mac.zip) · [使用说明](使用说明.md) · [版本记录](https://github.com/freedomxia/naigrey-pet/releases)
...
1. [**下载 Windows 安装程序：naigrey-windows-0.2.4-x64-setup.exe**](https://github.com/freedomxia/naigrey-pet/releases/download/windows-v0.2.4/naigrey-windows-0.2.4-x64-setup.exe)。
2. 如果旧版正在运行，先从托盘退出奶灰。
