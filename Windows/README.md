...
**[下载 Windows 安装程序（.exe）](https://github.com/freedomxia/naigrey-pet/releases/download/windows-v0.2.2/naigrey-windows-0.2.2-x64-setup.exe)**

文件名：`naigrey-windows-0.2.2-x64-setup.exe`。支持 **Windows 10 / 11，x64（64 位）**。
